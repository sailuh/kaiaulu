...
#' @export
#' @family {unittest}
make_jira_issue_new <- function(jira_domain_url, issue_key, issue_type, status, resolution, title, description, components, creator_name, reporter_name, assignee_name, comments = NULL) {
...
#' @export
make_jira_issue_tracker_new <- function(issues,save_filepath) {
  ...
  jsonlite::write_json(issues,save_filepath)
