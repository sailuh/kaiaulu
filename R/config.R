...
#' @param project_name the name of the project config file (e.g. "kaiaulu" or "geronimo")
#' @param project_key_index the name of the index of the project key (e.g. "project_key_1" or "project_key_2")
#' @return the local save path for GitHub issues
#' @export
...
#' @param project_name the name of the project config file (e.g. "kaiaulu" or "geronimo")
#' @param project_key_index the name of the index of the project key (e.g. "project_key_1" or "project_key_2")
#' @return the local save path for Github Issues or PR comments
#' @export
...
#' @param project_name the name of the project config file (e.g. "kaiaulu" or "geronimo")
#' @param project_key_index the name of the index of the project key (e.g. "project_key_1" or "project_key_2")
#' @return the local save path for GitHub issue search
#' @export
...
#' @param project_name the name of the project config file (e.g. "kaiaulu" or "geronimo")
#' @param project_key_index the name of the index of the project key (e.g. "project_key_1" or "project_key_2")
#' @return the local save path for GitHub pull requests
#' @export
...
#' @param project_name the name of the project config file (e.g. "kaiaulu" or "geronimo")
#' @param project_key_index the name of the index of the project key (e.g. "project_key_1" or "project_key_2")
#' @return the local save path for GitHub commits
#' @export
...
#'
#' Gets the project key for the Bugzilla project
#'
#' @param project_name the name of the project config file (e.g. "kaiaulu" or "geronimo")
#' @return the list of Jira issues comments paths
#' @export
