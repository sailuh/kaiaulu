...
#' @seealso \code{\link{download_bugzilla_comments_from_rest_api}} a downloader function to to download the issue comments
...
#'
#' @param bugzilla_site URL to specific bugzilla site
#' @param bug_ids the ids of the bugs to extract comments from \code{\link{download_bugzilla_issues_from_rest_api}}
