...
```{r}
file_graph <- parse_r_dependencies_network(dependencies,dependency_type="file")
...
```{r}
function_graph <- parse_r_dependencies_network(dependencies,dependency_type="function")
