...
Next we download repository commit comments from GitHub API. These comments are posted directly on commit pages and can be joined by `comment_id` for sentiment analysis.
