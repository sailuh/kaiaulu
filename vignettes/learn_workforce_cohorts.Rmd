...
The SD form is in the downstream SD model. `ctrl` = `Sr` (the senior
...
Running the downstream SD verdict pipeline (via
...
- the downstream SD model — the SD model under test.
