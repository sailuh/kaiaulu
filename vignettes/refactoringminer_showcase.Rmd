...
start_commit <- conf[["interval"]][["enumeration"]][["commit"]][1]
end_commit <- conf[["interval"]][["enumeration"]][["commit"]][2]

parse_java_code_refactoring_json(rminer_path,git_repo_path,start_commit,end_commit)
```
