...
save_path_issue_or_pr_comments <- "/home/vboxuser/kaiaulu/data/github_comments_json/"
...
plot_long <- rbindlist(list(
  plot_dt_normalized[, .(author_datetimetz, metric = "Communication - Messages (normalized)", value = author_total_messages)],
