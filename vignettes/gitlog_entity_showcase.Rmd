...
```{r}
project_commit_network <- transform_gitlog_to_entity_bipartite_network(last(id_project_git,
                                                                                   1000),
                                                                              mode ="commit-entity")
...
visIgraph(author_network,randomSeed = 1)
```
...
```{r}
project_temporal_collaboration_network <- transform_gitlog_to_entity_temporal_network(last(id_project_git,1000))
