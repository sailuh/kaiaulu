...
#3 different json files to test: 1 and 3 are the jsons straight from the browser, 2 is from Sean's new downloader
correct_json <- "../../rawdata/issue_tracker_new/search.json"
correct_json2 <- "../../rawdata/issue_tracker_new/apples.json"
correct_json3 <- "../../rawdata/issue_tracker_new/geronimo_issues_browser2.json"

poo <- jsonlite::read_json(correct_json2)
issue_comment <- poo[["issues"]][[1]][["fields"]][["description"]]
print(issue_comment)
