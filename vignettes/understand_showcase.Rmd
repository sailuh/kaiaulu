...
```{r}
project_path <- "tests/sample_project"
understand_folder <- "understand"
```
...
```{r}
build_understand_project(project_path = project_path, language = "java", output_dir = understand_folder)
```
