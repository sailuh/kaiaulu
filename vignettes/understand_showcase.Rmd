...
project_path <- get_understand_project_path(analysis)
...
# Scitools
understand_folder <- get_understand_output_path(analysis)
code_language <- get_understand_code_language(analysis)
