...
```{r eval = FALSE}
build_understand_project(scitools_path = scitools_path, project_path = project_path, language = code_language, output_dir = understand_folder)
```
...
```{r}
file_dependencies <- parse_understand_dependencies(scitools_path = scitools_path, understand_dir = understand_folder, parse_type = "file")
...
```{r}
class_dependencies <- parse_understand_dependencies(scitools_path = scitools_path, understand_dir = understand_folder, parse_type = "class")
