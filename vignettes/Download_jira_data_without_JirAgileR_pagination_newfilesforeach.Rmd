...
fetch_and_save_jira_issues <- function(domain, 
  ...
  # List existing files in the save path
  ...
  if(!is.null(username) && !is.null(password)){
    ...
    #saves each issue to separate file with the issue key and the time it was donwloaded. This can of course be changed to use different identifiers
