...
- mbox: The local directory where the downloaded archives will be saved.
...
mod_mbox <- conf[["mailing_list"]][["mod_mbox"]][["project_key_1"]][["mbox"]]
```
...
- mbox: The directory where the downloaded .mbox files will be saved.
...
conf <- yaml::read_yaml("../conf/helix.yml")
parse_mbox <- conf[["mailing_list"]][["mod_mbox"]][["project_key_1"]][["mbox"]]
```
