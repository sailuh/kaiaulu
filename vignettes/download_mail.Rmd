...
Just like with Pipermail, mailing list archives in Mod Mbox can be split across different formats or locations, and vary in completeness and available metadata. It is important to select the appropriate archive that is compatible with Kaiaulu and suits your analysis needs.
...
mbox_path: should point to the saved .mbox file that will be parsed. See the mbox_path in the mailing_list sections of helix.yml.
...
conf <- yaml::read_yaml("../conf/helix.yml")
mailing_list <- conf[["mailing_list"]][["mod_mbox"]][["project_key_1"]][["mbox_path"]]
