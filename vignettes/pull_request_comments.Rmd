...
## Explanation of GitHub Pull Request Comments
...
retrieved. Knowing this, it is important to filter out the issue
comments in this notebook. The key to this is in the html_url of each
comment, differentiated by /issues or /pull
...
pull_requests <- lapply(pull_requests, github_parse_pull_request)
pull_requests <- rbindlist(pull_requests,fill=TRUE)
