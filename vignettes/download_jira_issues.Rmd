...
```{r}
# # This sets a variable to find the most recent 'created' field of the issues that have been already save to the save path.
date_issues_upper_bound <- NULL
date_issues_lower_bound <- parse_jira_latest_date(refresh_issues)
message("The most recent issue downloaded was on ", date_issues_lower_bound)
message("Will download only issues created after this date")
```
...
all_issues <- download_and_save_jira_issues_by_created (issue_tracker_domain,
                           ...
                           verbose = TRUE,
                           maxDownloads = 400,
                           date_issues_lower_bound,
                           date_issues_upper_bound)
...
```{r}
# # This sets a variable to find the most recent 'created' field of the issue_comments that have been already save to the save path.
date_issue_comments_upper_bound <- NULL
date_issue_comments_lower_bound <- parse_jira_latest_date(refresh_issue_comments)
message("The most recent issue downloaded was on ", date_issue_comments_lower_bound)
message("Will download only issues created after this date")
```

```{r}
# Call the function and return only issues created after issueKey_lower_bound
all_issues <- download_and_save_jira_issues_by_created (issue_tracker_domain,
                           credentials, 
                           jql_query = paste0("project='",issue_tracker_project_key,"'"), 
                           fields = c("summary",
                           ...
                           verbose = TRUE,
                           maxDownloads = 400,
                           date_issue_comments_lower_bound,
                           date_issue_comments_upper_bound)
