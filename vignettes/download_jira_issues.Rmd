...
# This sets the value of created_latest. This will be replaced with the parsed actual value for the refresh function. "AND created > 'YYYY-MM-DD'" will be appended onto the jql query.
```{r}
#created_latest <- "'2008-01-01'"
```
