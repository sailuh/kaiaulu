...
# write_json(gh_response,paste0(save_path_issue, "file_name.json"),
...
gh_response <- github_api_project_issue_refresh(owner,repo,token)
# write_json(gh_response,paste0(save_path_issue, "file_name.json"),
#                pretty=TRUE,auto_unbox=TRUE)
```
```{r}
...
#gh call but with date
# get the data
gh_response_issue_or_pr_comment <- github_api_project_issue_or_pr_comment_refresh(owner,repo,token)
