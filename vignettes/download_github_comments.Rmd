...
save_path <- path.expand(conf[["github"]][["replies"]]) # Path you wish to save all raw data. A folder with the repo name and sub-folders will be created.
owner <- conf[["github"]][["owner"]] # Has to match github organization (e.g. github.com/sailuh)
repo <- conf[["github"]][["repo"]] # Has to match github repository (e.g. github.com/sailuh/perceive)
