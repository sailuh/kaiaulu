...
# 3rd Party Tools
perceval_path <- get_tools_project("perceval")
utags_path <- get_tools_project("utags")

# Ctags Line Types
kinds <- get_uctags_line_types("apr")

# Local Git Repo Folder Path
git_repo_path <- get_git_repo_path("apr")

# File Filters
file_extensions <- get_file_extensions("apr")
substring_filepath <- get_substring_filepath("apr")
```
