...
Example of an issue with an attachment: https://bugzilla.redhat.com/show_bug.cgi?id=2043044
...
```{r}
bugzilla_site <- "https://bugzilla.redhat.com/"
start_timestamp <- "2023-04-15T20:14:57Z"
...
For example, if you go to the issue comments on this Bugzilla page (https://bugzilla.redhat.com/show_bug.cgi?id=2187005), you'll notice that the first comment is actually the issue description.
```{r}
