...
for(j in 2:size_time_window){
  ...
  if (ml_exist & gitlog_exist){
    ...
    missing_links <- length(smell_missing_links(reply_network_authors,
                                                git_network_authors))
    # Social Technical Metrics
#    st_congruence <- community_metric_sociotechnical_congruence(reply_network_authors,git_network_authors)
