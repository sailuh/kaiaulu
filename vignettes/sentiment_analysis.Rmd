...
Add the CSV of the labeled data you would like to train here:
```{r}
...
Add the CSV of the unlabeled data you would like to train here:
```{r}
reply_dt <- fread("../predict_comments.csv")
