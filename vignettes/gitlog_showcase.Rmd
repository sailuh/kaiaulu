...
```{r}
project_contribution_network <- transform_gitlog_to_bipartite_network(project_git_slice,
                                                                      mode="author-file")
```
...
```{r}
author_network <- igraph::bipartite_projection(project_contribution_network,
                                          multiplicity = TRUE,
