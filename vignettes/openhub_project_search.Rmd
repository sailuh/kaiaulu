...
for (i in 1:length(openhub_portfolio_projects[["name"]])) {
  ...
  projects_api_requests[[i]] <- openhub_api_iterate_pages(token, openhub_api_projects, openhub_api_parameters, max_pages=1)
}
```
...
for (i in 1:length(projects_api_requests)) {
  project_name <- openhub_portfolio_projects[["name"]][[i]]
  openhub_api_parameters[["project_name"]] <- project_name
  openhub_projects[[i]] <- openhub_parse_projects(projects_api_requests[[i]], openhub_api_parameters)
}
