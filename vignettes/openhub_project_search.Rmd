...
This notebook demonstrates how to use Kaiaulu's OpenHub API interface functions to search for projects based on specific criteria: the organization to which the projects belong and the primary programming language used by the projects.
...
```{r, eval = FALSE}
max_portfolio_project_pages <- 1 # INCREASE THIS VALUE TO INCREASE THE LIMIT OF PAGES TO ACQURIE MORE MATCHING PROJECTS
