...
openhub_portfolio_projects <- openhub_portfolio_projects[primary_language == "java"]
...
```{r, eval = FALSE}
#kaiaulu_name <- "Kaiaulu"
#openhub_api_projects(token, project_folder_path, kaiaulu_name)
```
