 ...
 * Add new metric functions that measure developer engagement: `engagement_communication()`, `productivity_author_churn()`, `productivity_author_commits()`, and `jira_author_communication_count()`. [#402](https://github.com/sailuh/kaiaulu/issues/402)
