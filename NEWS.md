 ...
 * Add a new metric that aggregates the polarity (sentiment value) of an author's comments over a rolling window [#346](https://github.com/sailuh/kaiaulu/issues/346)
