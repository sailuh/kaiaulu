 ...
 * `config.R` now includes a set of functions that interact with OpenHub's API, Ohloh, enabling requests to various endpoints and parsing the resulting response files. [#317](https://github.com/sailuh/kaiaulu/issues/317)
